...
{
    public partial class FormTop10Movies : Form
    {
        public FormTop10Movies()
        {
            InitializeComponent();
        }

        private void FormTop10Movies_Load(object sender, EventArgs e)
        {
            dataGridView1.DataSource = MovieDatabase.Get10Movies();
