...
namespace MyMovieApp
{
    public partial class FormFollowing : Form
    {
        ...
        {
            dataGridView1.DataSource = MovieDatabase.GetFollowing();
            MovieDatabase.GetUnfollowedUsers(CmbUsers);
        }
        ...
        {
            MovieDatabase.FollowNewUser(CmbUsers.Text);
            dataGridView1.DataSource= MovieDatabase.GetFollowing();
            CmbUsers.Items.Clear();
            CmbUsers.Text = string.Empty;
            MovieDatabase.GetUnfollowedUsers(CmbUsers);
